...
export class RoutesController {
  ...
  @Get()
  @ApiResponse({ status: 200, description: 'Returns the list of routes', type: [RouteResponseDto] })
  async findAll() {
    return this.routesService.findAll();
  }

  @Get(':id')
  @ApiResponse({ status: 200, description: 'Returns the route by ID', type: RouteResponseDto })
