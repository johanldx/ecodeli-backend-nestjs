...
export class SubscriptionsController {
  ...
  @Get()
  @ApiResponse({ status: 200, description: 'Returns the list of subscriptions', type: [SubscriptionResponseDto] })
  async findAll(@Query() query: any) {
    return this.subscriptionsService.findAll(query);
  }

  @Get(':id')
  @ApiResponse({ status: 200, description: 'Returns a subscription by ID', type: SubscriptionResponseDto })
